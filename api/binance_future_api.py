...
if __name__ == '__main__':
    ...
    key ="x'x'x"
    secret = "x'x'x"
    binance = BinanceFutureApi(key, secret)
    ...
    #data=binance.get_latest_funding_fee('BTCUSDT', 100)
    #data=binance.get_all_funding_rate()
    data=binance.get_history_funding_rate('BTCUSDT', 100)
    print(data)
